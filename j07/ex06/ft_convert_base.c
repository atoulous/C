...
/*   Updated: 2015/11/06 10:15:51 by atoulous         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_determine_base(char *str)
{
	int		i;
...
int		ft_convert_10(char *nbr, char *base_from)
{
	int		i;
	int		j;
	int		res;
...
char	*ft_convert_to(char *nbr, char *base_from, char *base_to)
{
	int		i;
	int		num;
	int		base;
